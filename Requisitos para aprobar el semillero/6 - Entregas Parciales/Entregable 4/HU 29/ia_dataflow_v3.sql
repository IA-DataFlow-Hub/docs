-- ============================================================
-- IA DATAFLOW v3.11 - DATABASE STRUCTURE
...
--   - generated_tables: metadata + relaciones con proyecto/chat/IA + versionado.
--   - generated_table_columns: esquema/columnas por dataset.
-- HU-027: Gestión de templates ETL y transformaciones predefinidas.
--   - etl_templates + etl_template_steps: pipelines reutilizables.
--   - etl_executions + etl_execution_logs: historial, estado y trazabilidad.
-- HU-028: Feed de actividad y timeline de eventos.
--   - activity_feed: eventos cronológicos por proyecto con relaciones a entidades.
-- HU-029: Sistema de reportes y dashboards persistentes.
--   - analytics_reports + analytics_report_versions: dashboards versionados.
--   - analytics_report_widgets + analytics_report_metrics: visualizaciones y métricas.
--   - analytics_report_exports: archivos exportados (PDF/Excel/CSV/PNG/JSON).
--   - NOTA: prefijo analytics_ para evitar colisión con reports (HU-023, incidencias).
-- ============================================================
...
-- ============================================================
-- 20. GENERATED_TABLES  (HU-026: datasets/tablas generadas + lineage)
-- ============================================================
...
-- ============================================================
-- 21. GENERATED_TABLE_COLUMNS  (HU-026: columnas/esquema por dataset)
-- ============================================================
...
-- HU-027: seed mínimo de templates del sistema + pasos básicos
...
-- ============================================================
-- 26. MESSAGE_FEEDBACK  (HU-023: feedback de mensajes)
-- ============================================================
...
-- ============================================================
-- 26. ACTIVITY_FEED  (HU-028: feed/timeline unificado)
-- ============================================================
...
-- ============================================================
-- 27. ANALYTICS_REPORTS  (HU-029: reportes/dashboards persistentes)
-- ============================================================
...
-- ============================================================
-- 28. ANALYTICS_REPORT_VERSIONS  (HU-029: versionado de reportes)
-- ============================================================
...
-- ============================================================
-- 29. ANALYTICS_REPORT_WIDGETS  (HU-029: widgets/visualizaciones)
-- ============================================================
...
-- ============================================================
-- 30. ANALYTICS_REPORT_METRICS  (HU-029: métricas y fórmulas)
-- ============================================================
...
-- ============================================================
-- 31. ANALYTICS_REPORT_EXPORTS  (HU-029: archivos exportados)
-- ============================================================
...
-- HU-026: indexes para datasets/tablas generadas + lineage
...
-- HU-027: indexes para templates ETL y ejecuciones
...
-- HU-028: indexes para activity feed
...
-- HU-029: indexes para reportes/dashboards persistentes

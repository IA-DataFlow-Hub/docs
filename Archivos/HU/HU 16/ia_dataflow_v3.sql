...
--   1. Todos los ENUM reemplazados por tablas de catálogo (FK).
--   2. Cada catálogo expone: id, name UNIQUE, description, is_active, created_at.
--   3. Datos iniciales preservan los valores actuales de los ENUMs.
--   4. Defaults aplicados vía DEFAULT con el id correspondiente al valor
--      "por defecto" del ENUM original (mantiene compatibilidad funcional).
--   5. Índices añadidos en cada FK nueva para no degradar rendimiento.
-- ============================================================
